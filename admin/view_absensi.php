    ...
    if ($result_detail_absensi->num_rows > 0) {
        ...
        echo '<table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><img src="../karyawan/' . $row_detail_absensi['foto_selfie_masuk'] . '" alt="Foto Selfie Masuk" style="max-width: 100px;"></td>
                </tr>
                <tr>
                    <th>Foto Selfie Pulang</th>
                    <td><img src="../karyawan/foto/' . $row_detail_absensi['foto_selfie_pulang'] . '" alt="Foto Selfie Pulang" style="max-width: 100px;"></td>
                </tr>
                <tr>
                <td>
