...
WHERE users_k.id_karyawan = '$id_karyawan'";
                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $row['departemen']; ?></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Jabatan</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $row['jabatan']; ?></div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Tanggtal Bergabung</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $row['nama_golongan']; ?></div>
                                            <?php
    } else {
