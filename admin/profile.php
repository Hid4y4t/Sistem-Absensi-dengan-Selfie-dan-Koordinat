...
// Periksa apakah session ID_karyawan sudah ada
if(isset($_SESSION['karyawan_id'])) {
    $karyawan_id = $_SESSION['karyawan_id'];

    // Query untuk mengambil data karyawan berdasarkan ID
    $sql_karyawan = "SELECT users_k.*, golongan_gajih.nama_golongan
                    FROM users_k
                    LEFT JOIN golongan_gajih ON users_k.golongan = golongan_gajih.golongan_id
                                ...
                                <div class="card-body pt-3">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bordered">
                                        <li class="nav-item">
                                            <button class="nav-link active" data-bs-toggle="tab"
                                                data-bs-target="#profile-overview">Data Lengkap</button>
                                        </li>
                                    ...
                                    <div class="tab-content pt-2">
                                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                            ...
                                            <!-- Sisipkan data-data lainnya sesuai kebutuhan -->
                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 label">Jabatan</div>
                                                <div class="col-lg-9 col-md-8"><?php echo $row['jabatan']; ?>
                                                </div>
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 label">Departemen</div>
                                                <div class="col-lg-9 col-md-8"><?php echo $row['departemen']; ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 label">Tanggal Bergabung</div>
                                                <div class="col-lg-9 col-md-8"><?php echo $row['tanggal_bergabung']; ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-3 col-md-4 label">Golongan</div>
                                                <div class="col-lg-9 col-md-8"><?php echo $row['nama_golongan']; ?>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Sisipkan tab edit atau tab lainnya sesuai kebutuhan -->
    ...
    echo 'Session ID karyawan tidak valid.';
}
?>
...
if(isset($_SESSION['karyawan_id'])) {
    ...
    // Query untuk mengambil data karyawan berdasarkan ID
    $sql_karyawan = "SELECT * FROM users_k WHERE id_karyawan = '$karyawan_id'";
    ...
    if ($result_karyawan->num_rows > 0 && $result_golongan->num_rows > 0) {
        ...
        echo '<form class="row g-3" action="proses_edit_profile.php" method="POST">
                <div class="col-md-12">
                ...
                <div class="col-12">
                    ...
                    <input type="disabled" class="form-control" id="inputAddress2" name="jabatan" value="' . $row_karyawan['jabatan'] . '">
                </div>
                <div class="col-md-6">
